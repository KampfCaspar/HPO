...
/**
 * SoapClient Factor Interface
 *
 * Interface for SoapClient factories. Allows to work with different implementations.
 * */
interface SoapClientFactoryInterface {

	/** create a new SoapClient
	 *
	 * @param string $wsdl WSDL reference
	 * @param array  $opts (optional) client options, {@see SoapClient::__construct}
	 *
	 * @return SoapClient
	 */
